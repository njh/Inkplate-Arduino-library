/*
   Inkplate_basic_frontlight example for e-radionica.com Inkplate COOL
   For this example you will need a micro USB cable, Inkplate COOL and a device with WiFi and Internet brower (PC,
   Laptop, Smartphone, ...). Select "Inkplate COOL(ESP32)" from Tools -> Board menu. Don't have "Inkplate
   COOL(ESP32)" option? Follow our tutorial and add it: https://e-radionica.com/en/blog/add-inkplate-6-to-arduino-ide/

   This example will show you how to use Inkplate COOL frontlight.
