/*
   Basic_partial_update example for e-radionica Inkplate COOL
   ...
   In this example we will show how to use partial update functionality of Inkplate COOL e-paper display.
...
const char text[] = "This is partial update on Inkplate COOL e-paper display! :)";
...
void loop()
{
    ...
    if (offset < 0)
        offset = 600; // Text is scrolled till the end of the screen? Get it back on the start!
