/*
   Basic_monochorme example for e-radionica.com Inkplate COOL
...
#define DELAY_MS  5000 // Delay in milliseconds between screen refresh. Refreshing e-paper screens more often than 5s is not
                       // recommended
...
void loop()
{
    ...
    display.clearDisplay();
    display.drawFastHLine(100, 100, 500, BLACK); // Arguments are: starting X, starting Y, length, color
    ...
    display.clearDisplay();
    display.drawRect(200, 200, 300, 200, BLACK); // Arguments are: start X, start Y, size X, size Y, color
    ...
    display.clearDisplay();
    display.fillRect(200, 200, 300, 200, BLACK); // Arguments are: start X, start Y, size X, size Y, color
    ...
    display.clearDisplay();
    display.drawRoundRect(200, 200, 300, 300, 10,
    ...
    display.clearDisplay();
    display.fillRoundRect(200, 200, 300, 300, 10,
                          BLACK); // Arguments are: start X, start Y, size X, size Y, radius, color
