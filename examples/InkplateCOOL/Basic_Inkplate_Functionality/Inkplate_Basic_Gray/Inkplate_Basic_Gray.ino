/*
   Basic_gray example for e-radionica.com Inkplate COOL
...
void setup()
{
    ...
    display.print("Welcome to Inkplate COOL!");
...
void loop()
{
    ...
    display.clearDisplay();
    display.drawFastHLine(100, 100, 599, 0); // Arguments are: starting X, starting Y, length, color
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        display.print("INKPLATE COOL!");    // The actual text you want to show on e-paper as String
    }
