/*
   Inkplate_Wake_up_on_touchscreen example for e-radionica.com Inkplate COOL
   For this example you will need USB cable and an Inkplate COOL
   ...
   Here is shown how to use IO expander and ESP interrupts to wake up the MCU from 
   deepsleep when touchscreen or wake up button is pressed.
