/*
   Inkplate_Partial_Update_With_Deep_Sleep example for Soldered Inkplate COOL
   ...
   21 June 2022 by e-radionica.com
*/
...
void createScreen()
{
    display.setCursor(100, 300);      // Set text cursor @ X = 200, Y = 300
    ...
    display.setCursor(100, 340);       // Set text cursor @ X = 200, Y = 340
