/*
   Inkplate_WiFi_HTTP example for e-radionica.com Inkplate COOL
   For this example you will need USB cable, Inkplate COOL and stable WiFi Internet connection
