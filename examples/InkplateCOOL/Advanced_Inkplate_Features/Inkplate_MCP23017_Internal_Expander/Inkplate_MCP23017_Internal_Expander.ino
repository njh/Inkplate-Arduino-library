/*
   Inkplate_MCP23017 example for e-radionica.com Inkplate COOL
   For this example you will need only a micro USB cable, Inkplate COOL, 330 Ohm resistor and LED diode.
