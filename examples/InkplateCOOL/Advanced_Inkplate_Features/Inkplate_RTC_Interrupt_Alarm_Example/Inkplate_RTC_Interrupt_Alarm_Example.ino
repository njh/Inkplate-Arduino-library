/*
   Inkplate_RTC_Interrupt_Alarm_Example example for e-radionica Inkplate COOL
   For this example you will need USB cable and Inkplate COOL.
...
{
    display.clearDisplay();         // Clear frame buffer of display
    display.setCursor(20, 300);    // Set position of the text
    ...
    if (_alarmFlag)     // Check alarm flag
    {
        ...
        display.setCursor(400, 500);    // Set position of the text
