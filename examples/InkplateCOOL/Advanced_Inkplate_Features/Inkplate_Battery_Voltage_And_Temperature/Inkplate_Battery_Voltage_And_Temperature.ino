/*
   Inkplate_Battery_Voltage_And_Temperature example for e-radionica Inkplate COOL
   For this example you will need USB cable, Inkplate COOL and a Lithium battery (3.6V) with two pin JST connector.
