/*
   3-Google_calendar_example for e-radionica.com Inkplate COOL
   ...
   This project shows you how Inkplate COOL can be used to display
...
void setup()
{
    ...
    if (refreshes == 0)
    {
        ...
        display.println(F("Welcome to Inkplate COOL Google Calendar example!"));
...
void drawData()
{
    ...
    for (int i = 0; i < 3; ++i)
    {
        if (clogged[i])
        {
            ...
            display.fillRoundRect(6 + i * (594 / 3), 600 - 24, (594 / 3) - 5, 20, 10, 0);
