...
void setup()
{
    ...
    display.print(F("Welcome to Wol Inkplate COOL weather example!"));
    display.display();
    Serial.println("Welcome to Wol Inkplate COOL weather example!");
    display.display();
...
void drawTime()
{
    ...
    alignText(CENTRE_BOT, Output, 400, 110);
    Serial.print(Output);
    Serial.print(" ");
    ...
    alignText(CENTRE_BOT, Output, 400, 168);
