/*
   Inkplate_VariPass_Graphs example for e-radionica Inkplate COOL
   For this example you will need a micro USB cable, Inkplate COOL, and an available WiFi connection.
...
#error "Wrong board selection for this example, please select Inkplate COOL plus in the boards menu."
#endif
...
void setup()
{
    ...
    if (!display.drawBitmapFromWeb("https://api.varipass.org/?action=sgraph&id=kbg3eQfA&width=600&height=600&eink=true",
                                   0, 0))
    {
