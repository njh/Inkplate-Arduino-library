...
void setup()
{
    ...
    display.print(F("Welcome to Wol Inkplate 10 weather example!"));
    display.display();
...
void drawTime()
{
    ...
    display.fillRect(540, 0, 660, 237, WHITE);
...
{
    const int yTop = 251;
    const int yHeight = 210;
    const int xLeft = 360;
    const int xWidth = 720;
...
void drawMoon()
{
    const int MoonCentreX = 250;
    const int MoonCentreY = 100;
